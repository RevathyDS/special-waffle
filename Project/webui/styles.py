...
bg_dark_color = "#FAF9F6"
bg_medium_color = "#222"

border_color = "#1C1B20"

accennt_light = "1d4e89"
accent_color = "#14213d"
accent_dark = "#484b6a"

icon_color = "#fff8"

text_light_color = "#222"
...
message_style = dict(display="inline-block", p="4", border_radius="xl", max_w="45em")

input_style = dict(border_width="1px", padding="1em", box_shadow= "rgba(0, 0, 0, 0.15) 0px 2px 8px",border_color=border_color )
